...
Ingests GitHub Copilot CLI sessions from `~/.copilot/session-state` (`events.jsonl`), and carves multi-agent (squad) sessions into a parent run plus one child run per agent.
